...
//RaportFiskalnyDetailsScreen.kt
...
fun RaportFiskalnyDetailsScreen(
    ...
    GenericEditableDetailsScreen(
        ...
        onEditItem = { index, item ->
            viewModel.updateEditedProduct(index, item) {}
        },
        onDeleteItem = { item ->
        ...
        initialDate = raportFiskalny?.dataDodania?.time,
        onDateSelected = { it ->
            val newDate = viewModel.convertMillisToDate(it)
            viewModel.updateEditedRaport(0, raport!!.copy(dataDodania = newDate)) {}
        },
