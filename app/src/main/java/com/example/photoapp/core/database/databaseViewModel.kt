package com.example.photoapp.core.database
...
class DatabaseViewModel @Inject constructor(
    val paragonRepository: ParagonRepository,
    val fakturaRepository: FakturaRepository,
    val raportFiskalnyRepository: RaportFiskalnyRepository
...
//        viewModelScope.launch(Dispatchers.IO) {
//            paragonRepository.addRecipe(jsonString)
//        }
//    }
...
//        viewModelScope.launch(Dispatchers.IO) {
//            fakturaRepository.addFaktura(jsonString)
//        }
//    }
...
//        return runBlocking {
//            withContext(Dispatchers.IO) {
//                RaportFiskalnyRepository.addRaportFiskalny(jsonString)
//            }
//        }
//    }
//
...
//        return runBlocking {
//            withContext(Dispatchers.IO) {
//                RaportFiskalnyRepository.getRaportFiskalnyByID(id)
//            }
//        }
//    }
...
//        viewModelScope.launch(Dispatchers.IO) {
//            RaportFiskalnyRepository.addProduktyRaportFiskalny(jsonString, raport)
//        }
//    }
//
