...
import com.example.photoapp.features.faktura.presentation.details.DatePickerTarget
...
@Composable
fun AddByHandFaktura(
    backToHomeScreen: () -> Unit,
    viewModel: AddByHandFakturaViewModel = hiltViewModel(),
    ...
    Scaffold(
        ...
        LazyColumn (modifier = Modifier
            ...
            item {
                ...
                val newMiejsceWystawienia =
                    remember { mutableStateOf(editedFaktura.miejsceWystawienia) }
                InvoiceForm(
                    modifier = Modifier,
                    fields = listOf(
                        "Typ" to newTyp,
            ...
            itemsIndexed(
                ...
                key(product.produkt.id) {
                    ...
                    val wartoscNetto =
                        remember { mutableStateOf(product.produktFaktura.wartoscNetto) }
                    val wartoscBrutto =
                        remember { mutableStateOf(product.produktFaktura.wartoscBrutto) }
