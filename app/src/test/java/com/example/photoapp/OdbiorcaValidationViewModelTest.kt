...
class OdbiorcaValidationViewModelTest {
    ...
    private lateinit var viewModel: OdbiorcaValidationViewModel
    ...
    fun setup() {
        ...
        viewModel = OdbiorcaValidationViewModel()
    }
    ...
    fun `validate function returns valid when value is correct`() = runTest{
        ...
        // Given
        val odbiorcaNameGood = "Good Name"

        // When
        viewModel.validate(buyerName = odbiorcaNameGood) {
            latch.countDown()
        }
        latch.await()
    ...
    fun `validate function gives errors for buyerName`() = runTest{
        ...
        // When
        viewModel.validate(buyerName = odbiorcaNameBad) {
            latch.countDown()
        }
        latch.await()
